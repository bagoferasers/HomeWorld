Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/92b74632c7b78fd4a820230ff5c7f678"
{
	Properties
	{
		...
		_EmissionStrength_Spellbook ("Emission Strength", Range(0, 20)) = 0
		[Space(4)]
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _EmissionStrength_Spellbook;
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = _EmissionStrength_Spellbook;
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,0,0.1743317,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,0,0.1743317,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,0,0.1743317,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
